                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Police Station table</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="title">Police Station Table</strong>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                                foreach ($psta as $value) {
                                        ?>
                                         <tr>
                                            <td><?php echo $value->pstation_id ?> </td>
                                            <td><?php echo $value->pstation_address ?> </td>
                                            <td><?php echo $value->pstation_name ?> </td>
                                            <td><?php echo $value->incharge_contact ?> </td>
                                            <td><?php echo $value->incharge_name ?> </td>
                                            <td><?php echo $value->incharge_email ?> </td>
                                            <td> 
                                                <a href="/modify_pstation/<?php echo $value->pstation_id?>">Modify</a>
                                              <!-- <form method="POST" action="/modify_hospita">
                                                ...
                                                <button type="submit">Modify</button>
                                                  ...
                                                  / 
                                                  <a href="/remove_pstation/<?php echo $value->pstation_id?>">Remove</a></td>
                                        </tr>
                                ...
                                <center><a href="<?php echo e(url('/add_pstation')); ?>"><button class="btn">Add Police Station</button></a></center>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Accident\resources\views/Pstation/pstation.blade.php ENDPATH**/ ?>