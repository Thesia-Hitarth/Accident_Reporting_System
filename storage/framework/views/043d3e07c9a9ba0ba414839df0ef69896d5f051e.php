  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_number" id="id_25">
        ...
        <div id="cid_25" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            <select id="" name="" class=" form-number-input form-textbox validate[required]" style="width:100px"  value="" data-component="number" aria-labelledby="label_25 sublabel_input_25" step="any" required>
...
<li class="form-line jf-required" data-type="control_number" id="id_25">
        ...
        <div id="cid_25" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align:top">
            <select id="" name="" class=" form-number-input form-textbox validate[required]" style="width:100px" value=""   aria-labelledby="label_25 sublabel_input_25" step="any" required>
...
<?php /**PATH C:\xampp\htdocs\AAMS\resources\views/add_student.blade.php ENDPATH**/ ?>