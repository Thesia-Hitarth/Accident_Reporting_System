                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>CBM123</td>
                                            <td>0</td>
                                            <td><a href="modify_faculty.html">Modify</a> / <a href="remove_faculty.html">Remove</a></td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td>MMC</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>SGK123</td>
                                            <td>0</td>
                                            <td><a href="<?php echo e(url('/modify_faculty')); ?>">Modify</a> / <a href="<?php echo e(url('/remove_faculty')); ?>">Remove</a></td>  
                                        </tr>
                                        
                                    </tbody>
                                </table>
                                <center><a href="<?php echo e(url('/add_faculty')); ?>"><button class="btn69">Add Faculty</button></a></center>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\AAMS\resources\views/faculty.blade.php ENDPATH**/ ?>