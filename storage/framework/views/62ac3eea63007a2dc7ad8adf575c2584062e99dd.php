                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Hospital table</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="title">Hospital Table</strong>
                            ...
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                         <tr>
                                            ...
                                            <td><?php echo $value->hospital_address ?> </td>
                                            <td><?php echo $value->hospital_name ?> </td>
                                            <td><?php echo $value->incharge_contact ?> </td>
                                            <td><?php echo $value->incharge_name ?> </td>
                                            <td><?php echo $value->incharge_email ?> </hospital_nametd>
                                            <td> 
                                                <a href="/modify_hospital/<?php echo $value->hospital_id?>">Modify</a>
                                              <!-- <form method="POST" action="/modify_hospita">
                                                ...
                                                <button type="submit">Modify</button>
                                                  ...
                                                  / 
                                                  <a href="/remove_hospital/<?php echo $value->hospital_id?>">Remove</a></td>
                                        </tr>
                                ...
                                <center><a href="<?php echo e(url('/add_hospital')); ?>"><button class="btn">Add Hospital</button></a></center>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\Accident\resources\views/Hospital/hospital.blade.php ENDPATH**/ ?>