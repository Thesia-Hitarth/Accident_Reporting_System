                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Accident table</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="title">Accident Table</strong>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                         <tr>
                                            <td><?php echo $value->accident_id ?> </td>
                                            <td><?php echo $value->photo ?> </td>
                                            <td><?php echo $value->photo ?> </td>
                                            <td><?php echo $value->detailed_info ?> </td>
                                            <td> 
                                                <a href="/modify_accident/<?php echo $value->accident_id?>">Modify</a>
                                              <!-- <form method="POST" action="/modify_hospita">
                                                ...
                                                <button type="submit">Modify</button>
                                                  ...
                                                  / 
                                                  <a href="/remove_accident/<?php echo $value->accident_id?>">Remove</a></td>
                                        </tr>
                                ...
                                <center><a href="<?php echo e(url('/add_accident')); ?>"><button class="btn">Add Accident</button></a></center>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\AAMS\resources\views/Accident/accident.blade.php ENDPATH**/ ?>