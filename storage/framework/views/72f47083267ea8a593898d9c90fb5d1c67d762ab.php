        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(url('/faculty')); ?>"> Police Stations</a>
                    </li>

                    <li>
                        <a href="<?php echo e(url('/faculty')); ?>"> Fire Stations</a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Reported Accidents</a>
